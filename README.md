...
5. The output files Analyzed_Amazon_Echo_Dot_#_Reviews.txt will contain positive/negative/neutral for each comment based on the comments sentiment
6. A single matplotlib bar graph will be created showing the totals of the sentiments(positive, negative, neutral) for each product url
## What the Program Does
This program takes Ebay URLS as input and returns one output file for the analysis of those reviews for example whether those reviews are positive, negative, or neutral 
